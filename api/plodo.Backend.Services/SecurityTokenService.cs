...
public class SecurityTokenService : ISecurityTokenService
{
    ...
    {
        var signingKey = Convert.FromBase64String(_configuration["Jwt:SigningSecret"] ?? throw new InvalidOperationException());
        var expiryDuration = int.Parse(_configuration["Jwt:ExpiryDuration"] ?? throw new InvalidOperationException());
